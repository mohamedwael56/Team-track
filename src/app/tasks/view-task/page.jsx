...
<button className='cursor-pointer'><img src="/icons/comments.svg" alt="" /></button>
</div>
</div>
<hr />
...
<select className='bg-red-200 text-red-600 pl-2 py-1 rounded-lg' name="" id="">
    <option value="">To-do</option>
</select>
</div>
<div className='bg-gray-200 rounded-2xl items-center p-3 mt-3 justify-between flex text-black'>
<p>Adjust the size to responsive mobile.</p>
<select className='bg-green-100 text-green-600 pl-2 py-1 rounded-lg' name="" id="">
