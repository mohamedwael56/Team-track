...
<div className="flex justify-between items-center">
    <div className="flex gap-2 mb-1 flex-row items-center">
        ...
        <p className='text-black lg:text-sm text-[8px] font-bold'>{request.name}</p>
    </div>
    <div className="text-gray-400 lg:text-sm text-[8px]  ">{request.time}</div>
</div>
<div className="flex gap-1 justify-between items-center my-2">
    <p className='text-gray-400 lg:text-xs text-[8px]'>Sent you a collaboration invite to</p>
    <Link href='/lists/lists-invitations' className='font-bold lg:text-sm text-[8px] text-blue-500'> My List</Link>
</div>
